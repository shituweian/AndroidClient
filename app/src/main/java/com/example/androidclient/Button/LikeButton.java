package com.example.androidclient.Button;
...
public class LikeButton extends FrameLayout implements View.OnClickListener{
    ...
    public void setExplodingDotColorsRes( int primaryColor,  int secondaryColor) {
        ...
        dotsView.setColors(this.getResources().getColor(primaryColor), this.getResources().getColor(secondaryColor));
    }
    ...
    public void setCircleStartColorRes( int circleStartColor) {
        ...
        circleView.setStartColor(this.getResources().getColor(circleStartColor));
    }
    ...
    public void setCircleEndColorRes( int circleEndColor) {
        ...
        circleView.setEndColor(this.getResources().getColor(circleEndColor));
    }
